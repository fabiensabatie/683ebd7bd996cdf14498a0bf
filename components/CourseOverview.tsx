      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Understanding AI-Driven Monitoring of Ground-Nesting Birds
          </h1>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold text-gray-800 group-hover:text-black transition-colors">Introduction to the Study</h2>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold text-gray-800 group-hover:text-black transition-colors">Methodology: YOLOv10 for Curlew Detection</h2>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold text-gray-800 group-hover:text-black transition-colors">Results and Findings</h2>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold text-gray-800 group-hover:text-black transition-colors">Implications and Future Research</h2>
